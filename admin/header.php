<div class="navbar navbar-inverse set-radius-zero" >
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand">
                    ...
                    <img src="../public/assests/img/logo.png" />
                </a>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem2" data-toggle="dropdown"> Authors <i class="fa fa-angle-down"></i></a>
 ...
 <li class="dropdown">
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem3" data-toggle="dropdown"> Books <i class="fa fa-angle-down"></i></a>
                           ...
                           <li class="dropdown">
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem4" data-toggle="dropdown"> Issue Books <i class="fa fa-angle-down"></i></a>
